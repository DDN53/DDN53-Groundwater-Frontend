...
import DrillLogInfo from "../components/ViewDrill/DrillLogInfor";
import DrillLog from "../components/ViewDrill/DrillLog";

function ViewDrillInfo() {
  ...
  const [ setWellFormData] = useState({});
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await API.viewdrill(SampleId);
  ...
  const { toPDF, targetRef } = usePDF({
    filename: `${formData.SampleDate}_Drill_log_Information_${formData.newWellNo} ,${sanitizedDate}.pdf`,
  });
              ...
              <div className="p-3 border border-gray-400">
                ...
                <div className="py-3 border-t border-gray-500">
                  ...
                  <div className="w-[30%] mt-4">
                    {/*  */}
                    <DrillLogInfo formData={formData} /> 
                  </div>
                </div>
                <div className="py-3 border-t border-gray-500">
                  <div className="w-[100%] justify-center flex"></div>
